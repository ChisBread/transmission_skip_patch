...
LD_PRELOAD=$QPKG_ROOT/lib/libc.so.6 \
LD_LIBRARY_PATH=$QPKG_ROOT/lib:$LD_LIBRARY_PATH \
$QPKG_ROOT/lib/ld-linux.so.3 \
$QPKG_ROOT/bin/transmission-daemon -g $QPKG_ROOT/etc -e $QPKG_ROOT/etc/transmission.log -x /var/run/transmission.pid -f &
